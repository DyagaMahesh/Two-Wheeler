...
export ORDERER_ADDRESS=192.168.29.146:7015
export ORDERER_TLS_CA=/vars/keyfiles/ordererOrganizations/claim.com/orderers/orderer4.claim.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."policedepartment-claim-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.29.146","port": 7004}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json

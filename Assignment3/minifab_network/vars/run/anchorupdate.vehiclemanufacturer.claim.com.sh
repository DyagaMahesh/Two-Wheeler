...
jq '.channel_group.groups.Application.groups."vehiclemanufacturer-claim-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.29.146","port": 7007}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
